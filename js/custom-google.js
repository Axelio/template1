...
function drawChart3() {
  var data = google.visualization.arrayToDataTable([
    ['Año', 'Visitas', 'Orden', 'Ingreso', 'Egreso'],
...
function bubbleChart() {
  var data = google.visualization.arrayToDataTable([
    ['ID', 'Longitud de vida', 'Rango de Fertilidad', 'Región',     'Población'],
    ['CAN',    80.66,              1.67,      'América del Norte',  33739900],
    ['DEU',    79.84,              1.36,      'Europa',         81902307],
    ['DNK',    78.6,               1.84,      'Europa',         5523095],
    ['SL',     72.73,              2.78,      'Asia del Norte',    109716203],
    ['GBR',    80.05,              2,         'Europa',         61801570],
    ['IRN',    72.49,              1.7,       'Medio Este',    73137148],
    ['IRQ',    68.09,              4.77,      'Medio Este',    31090763],
    ['ISR',    81.55,              2.96,      'Medio Este',    7485600],
    ['RUS',    68.6,               1.54,      'Europa',         141850000],
    ['USA',    78.09,              2.05,      'América del Norote',  307007000]
    ]);
